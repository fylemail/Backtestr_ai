use backtestr_data::{Database, Tick, Result};
...
fn test_full_lifecycle() -> Result<()> {
    ...
    // Create test ticks
    let ticks = vec![
        Tick::new("EURUSD".to_string(), now - Duration::seconds(10), 1.0920, 1.0922)
            .with_sizes(1000000, 1000000),
        Tick::new("EURUSD".to_string(), now - Duration::seconds(5), 1.0921, 1.0923)
            .with_sizes(1500000, 1500000),
        Tick::new("EURUSD".to_string(), now, 1.0922, 1.0924)
            .with_sizes(2000000, 2000000),
